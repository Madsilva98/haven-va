...
Responde INFLUENCER quando um criador de conteúdo propõe experimentar uma aula (ou visitar o espaço) em troca de partilhar a experiência nas próprias redes sociais (posts, stories, reels) — a proposta é sobre conteúdo/promoção nas redes, não sobre um negócio conjunto.

Responde FORNECEDOR quando um vendedor, fornecedor, ou qualquer negócio está a tentar VENDER um produto ou serviço à Haven (equipamento, software, consumíveis, serviços profissionais, etc.) — o oposto de uma parceria: aqui é claramente uma venda, com a Haven como cliente potencial, não uma colaboração entre iguais. Não te deixes enganar pela linguagem do próprio vendedor: é comum empresas de software/API chamarem ao seu programa de acesso um "acordo de parceria" ("partnership agreement"), mas se o que está realmente em causa é pagar por um produto, serviço, ou integração técnica, continua a ser FORNECEDOR — o nome que a proposta usa não muda a natureza da relação.
