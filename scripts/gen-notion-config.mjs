...
const dbs = [
  ...
  },
  {
    ...
    rows: [
      ...
      ["Status", "select", "Planned | Drafted | Scheduled | Published | Archived", ""],
      ["Channel", "select", "Instagram | WhatsApp | Email | Newsletter | App | Website", ""],
      ["Pillar", "select", "Hub | Help Education | Help Haven | Hero | Customer Highlight | Promotional", ""],
      ["Type", "select", "Static | Carousel | Video | Story | Email | Message | LP | Page | Push Announcement | Banner | Other", ""],
      ["Copy", "text", "", ""],
      ["Image/Video Copy", "text", "", "overlay de imagem/vídeo, distinto do Copy"],
      ["Theme", "text", "", ""],
      ["Template", "text", "", ""],
      ["Assets", "url", "", ""],
  ...
  },
  {
    ...
    rows: [
      ["Propriedade", "Tipo", "Valores possíveis", "Notas"],
      ["Nome", "title", "", "bot cria nome como \"Objetivos {Founder} W{semana}\""],
      ["Founder", "select", "Madalena | Mafalda | Beatriz", ""],
      ["Semana", "number", "", "número da semana ISO — escrito pelo bot em cada criação"],
      ["Objetivos", "text", "", "weekly goals — accionáveis (apresentar/fazer/terminar), não progresso"],
      ["Ativo", "checkbox", "", "1 linha ativa por founder por semana"],
      ["Origem", "text", "", ""],
      ["Cumprido", "select", "Sim | Não", "escrito pelo bot no fecho de ciclo (domingo/segunda) se respondido; senão manual"],
