...
| [`competitor-intel.md`](competitor-intel.md) | Weekly newsletter → Notion competitor/inspiration intel cron: dedicated Outlook mailbox (live), one-off Gmail backfill (historical — why it moved off Gmail), dry-run | When the extractor prompt, mailbox/category names, or the live pipeline's data source change |
