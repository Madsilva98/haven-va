...
| [`competitor-intel.md`](competitor-intel.md) | Weekly newsletter → Notion competitor/inspiration intel cron: dedicated Outlook mailbox, unread-as-state, why it moved off Gmail | When the extractor prompt, mailbox address, or the pipeline's single-phase shape change |
