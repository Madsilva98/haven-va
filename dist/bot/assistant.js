...
function focusTargetWeek(target) {
    return weekOfYear() + (target === "proxima_semana" ? 1 : 0);
}
async function execAddToFocusBody(input, sender, ctx, collector) {
...
async function execEditFocusBody(input, sender, ctx, collector) {
